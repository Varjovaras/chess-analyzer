...
describe("Famous Chess Positions and Games", () => {
    describe("Famous Quick Checkmates", () => {
        test("Fool's Mate - fastest possible checkmate", () => {
            ...
            game = game.makeMove(
                algebraicToSquare("g2")!,
                algebraicToSquare("g4")!,
            )!;
        ...
        test("Légal's Mate - famous trap", () => {
            ...
            game = game.makeMove(
                algebraicToSquare("g7")!,
                algebraicToSquare("g6")!,
            )!;
            game = game.makeMove(
                algebraicToSquare("f3")!,
                algebraicToSquare("e5")!,
            )!; // Sacrifices queen to Bxd1
        ...
        test("Anderssen's Immortal Game - famous sacrifice position", () => {
            ...
            ); // Corrected Bishop start from f5 to c5 for Be7
            testBoard = setPieceAt(
                testBoard,
                { file: 3, rank: 4 },
            ...
            const result = game.makeMove(
                { file: 2, rank: 4 },
                { file: 4, rank: 6 },
            ); // Corrected Bishop move from c5 (was f5) to e7
    ...
    describe("Famous Endgame Positions", () => {
        ...
        test("Opposition in king and pawn endgame", () => {
            ...
            const kingMoves = game
                .getValidMoves()
                .filter((move) => move.piece.type === "KING");
    ...
    describe("Famous Tactical Motifs", () => {
        test("Fork - knight attacking king and queen", () => {
            ...
            const forkMove = game.makeMove(
                { file: 3, rank: 3 },
                { file: 2, rank: 1 },
            ); // Knight d4-c2, forking Ke1 and Qa1
        ...
        test("Discovered Check - moving piece reveals check", () => {
            ...
            const discoveredCheck = game.makeMove(
                { file: 4, rank: 4 },
                { file: 6, rank: 2 },
            );
    ...
    describe("Complex Pawn Structures", () => {
        test("Passed pawn race", () => {
            ...
            const pawnMoves = game
                .getValidMoves()
                .filter((move) => move.piece.type === "PAWN");
        ...
        test("Pawn breakthrough", () => {
            ...
            const breakthrough = game.makeMove(
                { file: 3, rank: 4 },
                { file: 3, rank: 5 },
            );
