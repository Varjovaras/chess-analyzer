...
describe("Chess Edge Cases and Complex Rules", () => {
    ...
    describe("Complex Pawn Promotion Scenarios", () => {
        ...
        test("Promotion with capture and check", () => {
            ...
            const capturePromotion = game.makeMove(
                { file: 4, rank: 6 },
                { file: 5, rank: 7 },
            );
    ...
    describe("Complex En Passant Scenarios", () => {
        test("En passant capture that reveals discovered check", () => {
            // Test that en passant is blocked when it would expose king to check
            const board = createEmptyBoard();
            let testBoard = setPieceAt(
                board,
                { file: 4, rank: 0 },
            ...
            // En passant should be blocked because it would expose white king to check from black rook
            const enPassant = game.makeMove(
                { file: 3, rank: 3 },
                { file: 4, rank: 4 },
            );
            expect(enPassant).toBeNull(); // Should be illegal due to discovered check
        });
        ...
        test("En passant blocked by own king being in check", () => {
            ...
            const illegalEnPassant = game.makeMove(
                { file: 3, rank: 3 },
                { file: 4, rank: 4 },
            );
    ...
    describe("Unusual Piece Interactions", () => {
        test("King capturing attacker while moving into another attack", () => {
            ...
            const illegalCapture = game.makeMove(
                { file: 4, rank: 4 },
                { file: 4, rank: 5 },
            );
        ...
        test("Piece pinned to king cannot move even if destination is safe", () => {
            ...
            const pinnedMove = game.makeMove(
                { file: 4, rank: 1 },
                { file: 3, rank: 1 },
            );
